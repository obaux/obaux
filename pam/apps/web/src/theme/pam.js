...
/**
 * pam theme — built by `pnpm exec astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { pamTheme } from './pam';
 *   import './pam.css';
 */
export const pamTheme = {
  name: 'pam',
  __built: true,
  tokens: {
    ...
    "--color-accent-muted": "light-dark(#E7EFE6, #DCE06824)",
    ...
    "--color-text-accent": "light-dark(#0F5847, #DCE068)",
    ...
    "--color-icon-accent": "light-dark(#0F5847, #DCE068)",
  ...
  __localTokenLineage: ["neutral","pam"],
  components: {
    "heading": {
      "level:1": {
