...
Last updated 2026-09-12, after the second import source filled the Education
category. Newest session log: `docs/sessions/2026-09-12-libraries-and-education.md`.
...
Philadelphia). Twenty-three migrations applied. The database is real and reachable;
...
| Database suite | 108 checks pass | See below |
...
| Browser a11y + theme | 63 pass | No WCAG AA violations at 320px or iPhone SE. Every control clears 48px. No horizontal scroll. The Astryx theme really resolves. Runs in dark mode as well as light. |
| First-load JS | 483.5 kB of 500 kB | §12 budget, measured gzipped on what `index.html` actually loads |
...
- `DECISIONS.md` — 52 decisions with their reasoning, and the open questions.
